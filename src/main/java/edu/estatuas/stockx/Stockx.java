...
public class Stockx {
    ...
    public static void main(String[] args) {
        ...
        sneaker.setBid(maximum.isEmpty()? 0 : maximum.getFirst().value());
        System.out.println(maximum.get(1).value());
        System.out.println(maximum.get(2).value());
        System.out.println(Stockx.draw(sneaker));
        ...
        sneaker.setAsk(minimum.isEmpty()? 0 : minimum.getFirst().value());
